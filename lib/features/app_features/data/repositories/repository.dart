...
import '../../data/datasources/local/constants/db_constants.dart';
import '../../data/datasources/local/datasources/board/board_datasource.dart';
import '../../data/datasources/local/datasources/boardItem/boardItem_datasource.dart';
import '../../data/datasources/local/datasources/organization/organization_datasource.dart';
import '../../data/datasources/local/datasources/project/project_datasource.dart';
import '../../data/datasources/network/apis/board/boardItem_api.dart';
import '../../data/datasources/network/apis/board/board_api.dart';
import '../../data/datasources/network/apis/posts/post_api.dart';
import '../../data/datasources/network/apis/projects/project_api.dart';
...
import '../datasources/local/datasources/post/post_datasource.dart';
import '../datasources/network/apis/organizations/organization_api.dart';
import '../datasources/sharedpref/shared_preference_helper.dart';
  ...
  Future<OrganizationList> getOrganizations() async {
    try {
      ...
      if (organizationList.organizations != null) {
        if (organizationList.organizations!.isNotEmpty) {
  ...
  Future<ProjectList> getProjects(int organizationId) async {
    try {
      ...
      if (projectList.projects != null) {
        if (projectList.projects!.isNotEmpty) {
          return projectList;
        }
      }
      // ProjectList
  ...
  Future<BoardList> getBoards(int projectId) async {
    ...
    try {
      ...
      if (boardList.boards != null) {
        if (boardList.boards!.isNotEmpty) {
          return boardList;
        }
      }
      // boardList
  ...
  Future<BoardItemList> getBoardItems(int boardId) async {
    ...
    try {
      ...
      if (boardItemList.boardItemList != null) {
        if (boardItemList.boardItemList!.isNotEmpty) {
